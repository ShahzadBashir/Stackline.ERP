...
namespace Stackline.API.Data.Migrations.Tenant
{
    ...
    [Migration("20260918054525_AddStockTransfers")]
            ...
            modelBuilder.Entity("Stackline.API.Data.Entities.StockAdjustment", b =>
                {
                    ...
                    b.ToTable("StockAdjustments", null, t =>
                        {
                            t.HasCheckConstraint("CK_StockAdjustments_Status", "\"Status\" IN ('Draft', 'Posted')");
                        });
                });

            modelBuilder.Entity("Stackline.API.Data.Entities.StockAdjustmentLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("StockAdjustmentId", "ItemId")
                        .IsUnique();

                    b.ToTable("StockAdjustmentLines", null, t =>
                        {
                            t.HasCheckConstraint("CK_StockAdjustmentLines_Direction", "\"Direction\" IN ('Increase', 'Decrease')");

                            t.HasCheckConstraint("CK_StockAdjustmentLines_Quantity", "\"Quantity\" > 0");
                        });
                });
            ...
            modelBuilder.Entity("Stackline.API.Data.Entities.SupplierPayment", b =>
                {
                    ...
                    b.HasIndex("SupplierId", "Status", "PaymentDate");
            ...
            modelBuilder.Entity("Stackline.API.Data.Entities.StockAdjustmentLine", b =>
                {
                    ...
                    b.HasOne("Stackline.API.Data.Entities.StockAdjustment", "StockAdjustment")
                        .WithMany("Lines")
